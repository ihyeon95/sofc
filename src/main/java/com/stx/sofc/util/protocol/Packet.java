...
public class Packet {
	...
	public Packet(byte command) {
		...
		switch(command) {
			...
			case PacketDef.HEATING2_MOD :
				data = new byte[PacketDef.DATA_HEATING2_SIZE + 1];
				shortToBytes_LE(PacketDef.DATA_HEATING2_SIZE, length);
				break;
			...
			case PacketDef.OPERATION_MOD :
				...
				break;
			case PacketDef.OPERATION2 :
			case PacketDef.OPERATION2_MOD :
				data = new byte[PacketDef.DATA_OPERATION2_SIZE + 1];
				shortToBytes_LE(PacketDef.DATA_OPERATION2_SIZE, length);
				break;
			...
			case PacketDef.ERROR_MOD :
				...
				break;
			case PacketDef.ERROR2 :
			case PacketDef.ERROR2_MOD :
				data = new byte[PacketDef.DATA_ERROR2_SIZE + 1];
				shortToBytes_LE(PacketDef.DATA_ERROR2_SIZE, length);
				break;
			case PacketDef.GAIN :
	...
	public void setData(byte command, Object obj) {
		...
		switch(command) {
			...
			case PacketDef.OPERATION2 :
			case PacketDef.OPERATION2_MOD :
				OperationParameters operaion2 = (OperationParameters) obj;

				// pump1_1
				int4 = intToBytes_LE(operaion2.getPump1_14().getCondition1());
				System.arraycopy(int4, 0, data, 0, 4);
				int4 = intToBytes_LE(operaion2.getPump1_14().getCondition3());
				System.arraycopy(int4, 0, data, 4, 4);
				int4 = intToBytes_LE(operaion2.getPump1_14().getSpeedValue());
				System.arraycopy(int4, 0, data, 8, 4);
				int4 = intToBytes_LE(operaion2.getPump1_14().getTargetValue());
				System.arraycopy(int4, 0, data, 12, 4);

				// pump1_2
				int4 = intToBytes_LE(operaion2.getPump1_15().getCondition1());
				System.arraycopy(int4, 0, data, 16, 4);
				int4 = intToBytes_LE(operaion2.getPump1_15().getCondition3());
				System.arraycopy(int4, 0, data, 20, 4);
				int4 = intToBytes_LE(operaion2.getPump1_15().getSpeedValue());
				System.arraycopy(int4, 0, data, 24, 4);
				int4 = intToBytes_LE(operaion2.getPump1_15().getTargetValue());
				System.arraycopy(int4, 0, data, 28, 4);

				// pump1_3
				int4 = intToBytes_LE(operaion2.getPump4_2().getCondition1());
				System.arraycopy(int4, 0, data, 32, 4);
				int4 = intToBytes_LE(operaion2.getPump4_2().getCondition3());
				System.arraycopy(int4, 0, data, 36, 4);
				int4 = intToBytes_LE(operaion2.getPump4_2().getSpeedValue());
				System.arraycopy(int4, 0, data, 40, 4);
				int4 = intToBytes_LE(operaion2.getPump4_2().getTargetValue());
				System.arraycopy(int4, 0, data, 44, 4);
				break;
			case PacketDef.OPERATION :
			case PacketDef.OPERATION_MOD :
				...
				// pump4_4
				int4 = intToBytes_LE(operaion.getPump4_4().getCondition1());
				System.arraycopy(int4, 0, data, 336, 4);
				int4 = intToBytes_LE(operaion.getPump4_4().getCondition3());
				System.arraycopy(int4, 0, data, 340, 4);
				int4 = intToBytes_LE(operaion.getPump4_4().getSpeedValue());
				System.arraycopy(int4, 0, data, 344, 4);
				int4 = intToBytes_LE(operaion.getPump4_4().getTargetValue());
			...
			case PacketDef.ERROR2 :
			case PacketDef.ERROR2_MOD :
				ErrorParameters error2 = (ErrorParameters) obj;

				// error08_1
				int4 = intToBytes_LE(error2.getError08_1().getCondition1());
				System.arraycopy(int4, 0, data, 0, 4);
				int4 = intToBytes_LE(error2.getError08_1().getCondition3());
				System.arraycopy(int4, 0, data, 4, 4);
				int4 = intToBytes_LE(error2.getError08_1().getSec());
				System.arraycopy(int4, 0, data, 8, 4);
				int4 = intToBytes_LE(error2.getError08_1().getTc3());
				System.arraycopy(int4, 0, data, 12, 4);

				// error08_2
				int4 = intToBytes_LE(error2.getError08_2().getCondition1());
				System.arraycopy(int4, 0, data, 16, 4);
				int4 = intToBytes_LE(error2.getError08_2().getCondition3());
				System.arraycopy(int4, 0, data, 20, 4);
				int4 = intToBytes_LE(error2.getError08_2().getSec());
				System.arraycopy(int4, 0, data, 24, 4);
				int4 = intToBytes_LE(error2.getError08_2().getTc3());
				System.arraycopy(int4, 0, data, 28, 4);
				break;
			case PacketDef.ERROR :
			case PacketDef.ERROR_MOD :
