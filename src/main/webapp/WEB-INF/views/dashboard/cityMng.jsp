...
<body>
	...
	<form id="cityForm">
							   ...
							   <div class="card">
							       <div class="card-body" style="overflow:auto;">
							           <div class="d-flex justify-content-between align-items-center mt-2">
							               <h4 class="header-title mb-0  mt-2">전국 발전 효율[%]</h4>
							           </div>
					...
					<div class="sales-report-area mt-5 mb-5">
						<div class="row">
							<div class="col-md-2">
								<div class="card">
									<div class="card-body">
										<h4 class="header-title">전국 전기에너지</h4>
										<div class="trad-history">
										    <div class="tab-content" id="myTabContent">
										        <div class="tab-pane fade show active" id="buy_order" role="tabpanel">
										            <div class="table-responsive">
							...
							<div class="col-md-2">
								 <div class="card">
									<div class="card-body">
										<h4 class="header-title">전국 열 에너지</h4>
										<div class="trad-history">
										    <div class="tab-content" id="myTabContent">
										        <div class="tab-pane fade show active" id="buy_order" role="tabpanel">
										            <div class="table-responsive">
							...
							<div class="col-md-2">
								<div class="card">
									<div class="card-body">
										<h4 class="header-title">전국 운영현황</h4>
										<div class="trad-history">
										    <div class="tab-content" id="myTabContent">
										        <div class="tab-pane fade show active" id="buy_order" role="tabpanel">
										            <div class="table-responsive">
							...
							<div class="col-md-3">
							    <div class="card">
							        <div class="card-body" style="overflow:auto;">
							            ...
							            <h4 class="header-title mb-0">전국 발전량 그래프</h4>
					...
					<div class="modal-body">
						<div class="form-row">
							<div class="col-md-12 mb-3">
							    <label for="iRtuNum" class="col-form-label">도시명</label>
							    <input class="form-control" type="text" value="" id="sCityNameText">
							</div>
		...
		<div class="modal fade bd-example-modal-sm" id="cityDeleteCheckModal">
			<div class="modal-dialog modal-sm">
				<div class="modal-content">
					...
					<div class="modal-body">
						<div id="sCityNameDel"></div> 도시를 삭제하시겠습니까?
						<input type="hidden" id="iSysNum">
					</div>
					<div class="modal-footer">
					    <button type="button" class="btn btn-secondary" data-dismiss="modal">취소</button>
					    <button type="button" class="btn btn-primary" onclick="javascript:fnDeleteCityInfo();">삭제</button>
					</div>
				</div>
			</div>
		</div>
		...
		function fnMeasureSearch() {
			...
			$.ajax({
				type : 'post',
				url : '/dashboard/city/measureList',
				data : params,
				global : false,
				dataType : 'JSON',
				beforeSend : function(xhr) {
			    ...
			    success : function(data) {
					...
					//console.log(data.systemCnt + "-> data.systemCnt");
		...
		function fnCityInfoInsert(){
			
			if($('#sCityNameText').val() == "") {
				alert("값을 모두 입력해주세요.");
			}else{
				var params = {
						"sCityName" : $('#sCityNameText').val()
				};
				
				$.ajax({
					type : 'post',
					url : '/dashboard/city/insertCityInfo',
					data : params,
					global : false,
					dataType : 'JSON',
					beforeSend : function(xhr) {
		...
		function fnDeleteCityInfoCheck(iCityNum, sCityName){
			
			$('#sCityNameDel').html(sCityName);
			$('#iCityNum').val(iCityNum);
			
			$('#cityDeleteCheckModal').modal();
			
			
		}
		
		function fnDeleteCityInfo(){
			...
			$.ajax({
				type : 'post',
				url : '/dashboard/city/deleteCityInfo',
				data : params,
				global : false,
				dataType : 'JSON',
				beforeSend : function(xhr) {
				...
				success : function(data) {
					if(data.result == "success") {
						...
						$('#cityDeleteCheckModal').modal('hide');
